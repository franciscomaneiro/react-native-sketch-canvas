...
```bash
npm install @franciscomaneiro/react-native-sketch-canvas --save
```
Link native code
```bash
react-native link @franciscomaneiro/react-native-sketch-canvas
```
...
import { SketchCanvas } from '@franciscomaneiro/react-native-sketch-canvas';
...
import RNSketchCanvas from '@franciscomaneiro/react-native-sketch-canvas';
...
## Troubleshooting
-------------
Please refer  [here](https://github.com/franciscomaneiro/react-native-sketch-canvas/wiki/Troubleshooting).
